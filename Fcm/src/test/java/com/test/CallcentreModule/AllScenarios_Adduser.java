...
public class AllScenarios_Adduser extends Base_Class {
...
//				String Employee = testdata.get("Employee").toString();
			...
			Thread.sleep(5000);
			ExtentTestManager.startTest("TestScenario01 : Add user");
			Thread.sleep(3000);
			Log.info("before RoleManagmentModule !");
			boolean flag1 = Addusermodule.Newusermodule(); 
			Log.info("after RoleManagmentModule !");
			
			Thread.sleep(5000);
			ExtentTestManager.startTest("TestScenario01 : click submitbutton ");
			Thread.sleep(3000);
			Log.info("before RoleManagmentModule !");
			boolean flag4 = Addusermodule.submitbutton(); 
			Log.info("after RoleManagmentModule !");
			Thread.sleep(5000);
			ExtentTestManager.startTest("TestScenario01 : enter executive id ");
			Thread.sleep(3000);
			Log.info("before RoleManagmentModule !");
			boolean flag2 = Addusermodule.enterexecutive(); 
			Log.info("after RoleManagmentModule !");
			Thread.sleep(5000);
			
			ExtentTestManager.startTest("TestScenario01 : enter name  ");
			Thread.sleep(3000);
			Log.info("before RoleManagmentModule !");
			boolean flag3 = Addusermodule.entername(); 
			Log.info("after RoleManagmentModule !");
			Thread.sleep(5000);
			
			ExtentTestManager.startTest("TestScenario01 : enter mail  ");
			Thread.sleep(3000);
			Log.info("before RoleManagmentModule !");
			boolean flag5 = Addusermodule.email(); 
			Log.info("after RoleManagmentModule !");
			Thread.sleep(5000);
